import { FeedbackConfigState } from '../../src/hooks/useFeedbackConfig';
...
export function SettingsPage({ config, updateSetting, saveSettings, hasUnsavedChanges, isPro, loading }: SettingsPageProps) {
