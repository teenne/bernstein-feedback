...
export function FeedbackToast() {
  ...
  return (
    <div
      className={`bf-fixed bf-bottom-4 bf-right-4 bf-z-[10000] bf-transition-all bf-duration-300 ${isVisible ? 'bf-opacity-100 bf-translate-y-0' : 'bf-opacity-0 bf-translate-y-2'
        }`}
    >
      <div
        className={`bf-flex bf-items-start bf-gap-3 bf-p-4 bf-rounded-lg bf-shadow-lg bf-max-w-sm ${isSuccess
      ...
      >
        ...
        <div className="bf-flex-1 bf-min-w-0">
          <p
            className={`bf-text-sm bf-font-medium ${isSuccess ? 'bf-text-green-800' : 'bf-text-red-800'
              }`}
          >
            {toast.message}
          </p>
        ...
        <button
          ...
          className={`bf-flex-shrink-0 bf-p-1 bf-rounded bf-transition-colors ${isSuccess
